...
class Basket {
 ...
 constructor(discountPlan) {
  ...
  calculateTotalPrice() {
    ...
    return this.discountPlan.applyDiscount(totalPrice); // Застосовуємо знижку до загальної вартості за допомогою метода applyDiscount нашого об'єкта discountPlan
  }
